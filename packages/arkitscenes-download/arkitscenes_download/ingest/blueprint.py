...
def make_blueprint(portrait: bool = False, include_promptda: bool = False) -> rrb.Blueprint:
    ...
    """
    world_view = rrb.Spatial3DView(name="world", origin=f"/{WORLD}", eye_controls=rrb.archetypes.EyeControls3D(spin_speed=0.25))
