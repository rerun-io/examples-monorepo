"""Runtime backends: one tensor-function contract over PyTorch, ONNX Runtime, and TensorRT.
...
from posekit.runtimes.base import RuntimeSpec, TensorRuntime, TensorSpec, validate_runtime_inputs
from posekit.runtimes.onnx_cuda import OnnxCudaRuntime
from posekit.runtimes.tensorrt_runtime import TensorRtRuntime
from posekit.runtimes.torch_runtime import TorchRuntime
from posekit.runtimes.trt_builder import DEFAULT_TRT_CACHE_DIR, TrtBuildConfig, TrtPrecision, ensure_engine

__all__ = (
    "AnnotatedBackendConfig",
    "BackendConfig",
    "OnnxBackendConfig",
...
AnnotatedBackendConfig = tyro.conf.OmitSubcommandPrefixes[BackendConfig]
...
def create_runtime_from_onnx(onnx_path: Path, backend: "OnnxBackendConfig | TensorRtBackendConfig") -> TensorRuntime:
    ...
    Returns:
        A ready runtime satisfying the posekit tensor-function contract.
    """
    ...
    from posekit.artifacts import onnx_static_batch_size
