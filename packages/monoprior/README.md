...
cd monoprior
pixi run -e monoprior monoprior-depth-compare-app
```
...
```bash
pixi run -e monoprior monoprior-relative-depth          # Single-image relative depth
pixi run -e monoprior monoprior-multiview-depth          # VGGT multi-view depth
pixi run -e monoprior monoprior-multiview-calibration    # Multi-view calibration
pixi run -e monoprior monoprior-video-depth              # Video depth estimation
pixi run -e monoprior monoprior-polycam-inference        # Polycam dataset inference
pixi run -e monoprior monoprior-promptda-polycam         # PromptDA depth completion
pixi run -e monoprior monoprior-surface-normals          # Compare surface normal models
```

### Gradio web UIs
```bash
pixi run -e monoprior monoprior-depth-compare-app        # Depth comparison UI
pixi run -e monoprior monoprior-metric-depth-app         # Metric depth UI
pixi run -e monoprior monoprior-calibration-app          # Multi-view calibration UI
```
...
```bash
pixi run -e monoprior monoprior-multiview-depth
```
