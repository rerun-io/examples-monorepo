...
def test_img_gradient_shape_preserved() -> None:
    ...
    img: Float[torch.Tensor, "1 3 16 16"] = torch.randn(1, 3, 16, 16)
    gx: Float[torch.Tensor, "1 3 16 16"]
    gy: Float[torch.Tensor, "1 3 16 16"]
...
def test_img_gradient_constant_image() -> None:
    ...
    img: Float[torch.Tensor, "1 1 8 8"] = torch.ones(1, 1, 8, 8) * 42.0
    gx, gy = img_gradient(img)
...
def test_img_gradient_horizontal_step() -> None:
    ...
    img: Float[torch.Tensor, "1 1 8 8"] = torch.zeros(1, 1, 8, 8)
