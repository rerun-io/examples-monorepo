...
std::vector<torch::Tensor> gauss_newton_points_step(
  torch::Tensor Twc, torch::Tensor Xs, torch::Tensor Cs,
  torch::Tensor ii, torch::Tensor jj,
  torch::Tensor idx_ii2jj, torch::Tensor valid_match,
  torch::Tensor Q,
  ...
  return gauss_newton_points_step_cuda(
...
std::vector<torch::Tensor> gauss_newton_rays_step(
  torch::Tensor Twc, torch::Tensor Xs, torch::Tensor Cs,
  torch::Tensor ii, torch::Tensor jj,
  torch::Tensor idx_ii2jj, torch::Tensor valid_match,
  torch::Tensor Q,
  ...
  return gauss_newton_rays_step_cuda(
      Twc, Xs, Cs, ii, jj, idx_ii2jj, valid_match, Q,
...
std::vector<torch::Tensor> gauss_newton_calib_step(
  torch::Tensor Twc, torch::Tensor Xs, torch::Tensor Cs,
  torch::Tensor K,
  torch::Tensor ii, torch::Tensor jj,
  torch::Tensor idx_ii2jj, torch::Tensor valid_match,
  ...
  return gauss_newton_calib_step_cuda(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("gauss_newton_points_step", &gauss_newton_points_step, "gauss_newton point accumulation step");
