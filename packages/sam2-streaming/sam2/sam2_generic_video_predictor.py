...
class SAM2GenericVideoPredictorVOS(SAM2GenericVideoPredictor):
    ...
    def forward_embeddings(
        ...
        img_embeddings = [m.clone() for m in img_embeddings]
        img_pos_embeddings = [m.clone() for m in img_pos_embeddings]
        prompts = [p.clone() for p in prompts]
        ...
        for obj_id in all_obj_ids:
            ...
            if has_prompt:
                ...
                prompt_embeddings = [m.clone() for m in prompt_embeddings]
                ...
                conditioned_img_embeddings = [m.clone() for m in conditioned_img_embeddings]
