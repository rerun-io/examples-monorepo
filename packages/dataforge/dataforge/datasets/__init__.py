...
dataset_defaults: dict[str, DataforgeDatasetConfig] = {
    config.command: config for config in (AriaGen2PilotConfig(), HocapConfig(), Hot3dAriaConfig(), Hot3dQuest3Config(), LamariaConfig(), MsdConfig(), RobocapConfig(), SelfcapConfig(), Show3dConfig(), WildcapConfig())
}
