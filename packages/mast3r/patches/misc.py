...
class _TransposeToLandscapeNo:
    """Picklable replacement for transpose_to_landscape closure (activate=False)."""
...
class _TransposeToLandscapeYes:
    """Picklable replacement for transpose_to_landscape closure (activate=True)."""
...
def transpose_to_landscape(head, activate=True):
    """Predict in the correct aspect-ratio, then transpose the result in landscape
    and stack everything back together. Returns a picklable callable."""
